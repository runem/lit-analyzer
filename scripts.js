...
async function copyPackage(linkPackageName, destPackageName) {
	...
	await remove(`./packages/${destPackageName}/node_modules/${linkPackageName}/node_modules/web-component-analyzer`);
	...
	const extraneous = ["fast-glob", "glob-parent", "micromatch", "@nodelib/fs.stat", "braces", "fill-range", "to-regex-range", "is-number"];
