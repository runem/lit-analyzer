...
export function findTaggedTemplates(sourceFile: SourceFile, templateTags: string[], position?: number): TaggedTemplateExpression[] | TaggedTemplateExpression | undefined {
	if (position != null) {
