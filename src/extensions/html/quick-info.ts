...
export function quickInfoForHtmlNode(htmlNode: HtmlNode, store: TsLitPluginStore): QuickInfo | undefined {
...
export function quickInfoForHtmlAttr(htmlAttr: HtmlNodeAttr, store: TsLitPluginStore): QuickInfo | undefined {
	...
	const declaration = store.getComponentDeclaration(htmlAttr.name);
