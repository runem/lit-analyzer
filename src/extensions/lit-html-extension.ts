...
import { DIAGNOSTIC_SOURCE, LitHtmlAttributeModifier } from "../constants";
...
import { VanillaHtmlExtension } from "./vanilla-html-extension";
...
export class LitHtmlExtension extends VanillaHtmlExtension {
	 ...
	 * @param context
	 */
	diagnosticsForHtmlAttrReport(htmlAttr: HtmlAttr, htmlReport: HtmlReport, context: ITsHtmlExtensionDiagnosticContext): DiagnosticWithLocation[] {
		...
		return [
			...(super.diagnosticsForHtmlAttrReport(htmlAttr, htmlReport, context) || []),
			...(messageText != null
				? [
						{
							file: context.file,
