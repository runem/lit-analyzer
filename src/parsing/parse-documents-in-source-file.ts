...
import { HtmlNodeKind, IHtmlNodeStyleTag } from "./text-document/html-document/parse-html-node/types/html-node-types";
...
export function parseDocumentsInSourceFile(sourceFile: SourceFile, options: ParseDocumentOptions, position?: number): TextDocument[] | TextDocument | undefined {
